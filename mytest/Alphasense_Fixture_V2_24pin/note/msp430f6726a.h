...
#error msp430f6726a.h file for use with ICC430/A430 only
#endif
...
#define  BAKMEM1_               (0x0482u)  /* Battery Backup Memory 1 */
DEFCW(   BAKMEM1              , BAKMEM1_)
#define  BAKMEM2_               (0x0484u)  /* Battery Backup Memory 2 */
DEFCW(   BAKMEM2              , BAKMEM2_)
#define  BAKMEM3_               (0x0486u)  /* Battery Backup Memory 3 */

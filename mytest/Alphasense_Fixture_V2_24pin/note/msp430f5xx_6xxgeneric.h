...
#define __MSP430_HEADER_VERSION__ 1190
...
#define AESOP_2             (0x0002u)  /* AES Operation: Generate first round Key */
#define AESOP_3             (0x0003u)  /* AES Operation: Decrypt (first round Key) */
...
#define CTSD16REFS_L        (0x0004u)  /* CTSD16 reference select */
#define CTSD16CLKR_L        (0x0008u)  /* CTSD16CLK resistor select */
#define CTSD16OFFG_L        (0x0010u)  /* CTSD16 clock fault flag */

#define CTSD16RRIBURST_H    (0x0001u)  /* Rail-to-rail input charge pump burst mode request */
#define CTSD16RRIRDY_H      (0x0002u)  /* CTSD16 Rail-to-rail input ready */
#define CTSD16RRIERR_H      (0x0004u)  /* CTSD16 Rail-to-rail input error */

/* CTSD16CCTLx */
#define CTSD16GRP              (0x0001u)  /* CTSD16 group */
#define CTSD16SC               (0x0002u)  /* CTSD16 Start Conversion */
#define CTSD16DF               (0x0010u)  /* CTSD16 Data Format */
#define CTSD16LSBACC           (0x0040u)  /* CTSD16 LSB access */
#define CTSD16LSBTOG           (0x0080u)  /* CTSD16 LSB toggle */
#define CTSD16OSR0             (0x0100u)  /* CTSD16 Channel OverSampling Ratio 0 */
#define CTSD16OSR1             (0x0200u)  /* CTSD16 Channel OverSampling Ratio 1 */
#define CTSD16SNGL             (0x0400u)  /* CTSD16 Channel Single Conversion Mode */

#define CTSD16GRP_L         (0x0001u)  /* CTSD16 group */
#define CTSD16SC_L          (0x0002u)  /* CTSD16 Start Conversion */
#define CTSD16DF_L          (0x0010u)  /* CTSD16 Data Format */
#define CTSD16LSBACC_L      (0x0040u)  /* CTSD16 LSB access */
#define CTSD16LSBTOG_L      (0x0080u)  /* CTSD16 LSB toggle */

#define CTSD16OSR0_H        (0x0001u)  /* CTSD16 Channel OverSampling Ratio 0 */
#define CTSD16OSR1_H        (0x0002u)  /* CTSD16 Channel OverSampling Ratio 1 */
#define CTSD16SNGL_H        (0x0004u)  /* CTSD16 Channel Single Conversion Mode */

#define CTSD16OSR_0            (0x0000u)  /* CTSD16 Channel OverSampling Ratio 0 */
#define CTSD16OSR_1            (0x0100u)  /* CTSD16 Channel OverSampling Ratio 1 */
#define CTSD16OSR_2            (0x0200u)  /* CTSD16 Channel OverSampling Ratio 2 */
#define CTSD16OSR_3            (0x0300u)  /* CTSD16 Channel OverSampling Ratio 3 */

#define CTSD16OSR__256         (0x0000u)  /* CTSD16 Channel OverSampling Ratio: 256 */
#define CTSD16OSR__128         (0x0100u)  /* CTSD16 Channel OverSampling Ratio: 128 */
#define CTSD16OSR__64          (0x0200u)  /* CTSD16 Channel OverSampling Ratio:  64 */
#define CTSD16OSR__32          (0x0300u)  /* CTSD16 Channel OverSampling Ratio:  32 */

/* CTSD16INCTLx */
#define CTSD16INCH0           (0x0001u)  /* CTSD16 Input Channel select 0 */
#define CTSD16INCH1           (0x0002u)  /* CTSD16 Input Channel select 1 */
#define CTSD16INCH2           (0x0004u)  /* CTSD16 Input Channel select 2 */
#define CTSD16INCH3           (0x0008u)  /* CTSD16 Input Channel select 3 */
#define CTSD16INCH4           (0x0010u)  /* CTSD16 Input Channel select 4 */
#define CTSD16GAIN0           (0x0020u)  /* CTSD16 Input Pre-Amplifier Gain Select 0 */
#define CTSD16GAIN1           (0x0040u)  /* CTSD16 Input Pre-Amplifier Gain Select 1 */
#define CTSD16GAIN2           (0x0080u)  /* CTSD16 Input Pre-Amplifier Gain Select 2 */
#define CTSD16INTDLY          (0x0100u)  /* CTSD16 Interrupt Delay after 1.Conversion */
#define CTSD16BUFOFF          (0x0400u)  /* CTSD16 Controls input buffer */
#define CTSD16RRI             (0x0800u)  /* CTSD16 Rail-to-rail input enable */

#define CTSD16INCH0_L       (0x0001u)  /* CTSD16 Input Channel select 0 */
#define CTSD16INCH1_L       (0x0002u)  /* CTSD16 Input Channel select 1 */
#define CTSD16INCH2_L       (0x0004u)  /* CTSD16 Input Channel select 2 */
#define CTSD16INCH3_L       (0x0008u)  /* CTSD16 Input Channel select 3 */
#define CTSD16INCH4_L       (0x0010u)  /* CTSD16 Input Channel select 4 */
#define CTSD16GAIN0_L       (0x0020u)  /* CTSD16 Input Pre-Amplifier Gain Select 0 */
#define CTSD16GAIN1_L       (0x0040u)  /* CTSD16 Input Pre-Amplifier Gain Select 1 */
#define CTSD16GAIN2_L       (0x0080u)  /* CTSD16 Input Pre-Amplifier Gain Select 2 */

#define CTSD16INTDLY_H      (0x0001u)  /* CTSD16 Interrupt Delay after 1.Conversion */
#define CTSD16BUFOFF_H      (0x0004u)  /* CTSD16 Controls input buffer */
#define CTSD16RRI_H         (0x0008u)  /* CTSD16 Rail-to-rail input enable */

#define CTSD16GAIN_1          (0x0000u)  /* CTSD16 Input Pre-Amplifier Gain Select *1  */
#define CTSD16GAIN_2          (0x0020u)  /* CTSD16 Input Pre-Amplifier Gain Select *2  */
#define CTSD16GAIN_4          (0x0040u)  /* CTSD16 Input Pre-Amplifier Gain Select *4  */
#define CTSD16GAIN_8          (0x0060u)  /* CTSD16 Input Pre-Amplifier Gain Select *8  */
#define CTSD16GAIN_16         (0x0080u)  /* CTSD16 Input Pre-Amplifier Gain Select *16 */

#define CTSD16INCH_0          (0x0000u)  /* CTSD16 Input Channel select A0 */
#define CTSD16INCH_1          (0x0001u)  /* CTSD16 Input Channel select A1 */
#define CTSD16INCH_2          (0x0002u)  /* CTSD16 Input Channel select A2 */
#define CTSD16INCH_3          (0x0003u)  /* CTSD16 Input Channel select A3 */
#define CTSD16INCH_4          (0x0004u)  /* CTSD16 Input Channel select A4 */
#define CTSD16INCH_5          (0x0005u)  /* CTSD16 Input Channel select A5 */
#define CTSD16INCH_6          (0x0006u)  /* CTSD16 Input Channel select Temp */
#define CTSD16INCH_7          (0x0007u)  /* CTSD16 Input Channel select Vcc */
#define CTSD16INCH_8          (0x0008u)  /* CTSD16 Input Channel select VBat */
#define CTSD16INCH_9          (0x0009u)  /* CTSD16 Input Channel select AD0+ / AD0- */
#define CTSD16INCH_10         (0x000Au)  /* CTSD16 Input Channel select AD0+ / VREF */
#define CTSD16INCH_11         (0x000Bu)  /* CTSD16 Input Channel select AD1+ / AD1- */
#define CTSD16INCH_12         (0x000Cu)  /* CTSD16 Input Channel select AD1+ / VREF*/
#define CTSD16INCH_13         (0x000Du)  /* CTSD16 Input Channel select AD2+ / AD2- */
#define CTSD16INCH_14         (0x000Eu)  /* CTSD16 Input Channel select AD2+ / VREF*/
#define CTSD16INCH_15         (0x000Fu)  /* CTSD16 Input Channel select AD3+ / AD3 -*/
#define CTSD16INCH_16         (0x0010u)  /* CTSD16 Input Channel select AD3+ / VREF*/
#define CTSD16INCH_17         (0x0011u)  /* CTSD16 Input Channel select AD4x - VREF*/
#define CTSD16INCH_18         (0x0012u)  /* CTSD16 Input Channel select AD4x - DAC0 */

/* CTSD16IFG */
#define CTSD16IFG0            (0x0001u)  /* CTSD16 Channel 0 Interrupt Flag */
#define CTSD16OVIFG0          (0x0100u)  /* CTSD16 Channel 0 Overflow Interrupt Flag */

#define CTSD16IFG0_L        (0x0001u)  /* CTSD16 Channel 0 Interrupt Flag */

#define CTSD16OVIFG0_H      (0x0001u)  /* CTSD16 Channel 0 Overflow Interrupt Flag */

/* CTSD16IE */
#define CTSD16IE0             (0x0001u)  /* CTSD16 Channel 0 Interrupt Enable */
#define CTSD16OVIE0           (0x0100u)  /* CTSD16 Channel 0 Overflow Interrupt Enable */

#define CTSD16IE0_L         (0x0001u)  /* CTSD16 Channel 0 Interrupt Enable */

#define CTSD16OVIE0_H       (0x0001u)  /* CTSD16 Channel 0 Overflow Interrupt Enable */

/* CTSD16IV Definitions */
#define CTSD16IV_NONE         (0x0000u)    /* No Interrupt pending */
#define CTSD16IV_CTSD16OVIFG  (0x0002u)    /* CTSD16OVIFG */
#define CTSD16IV_CTSD16MEM0   (0x0004u)    /* CTSD16MEM0-CTSD16IFG0 */
...
#define LCDBLKPRE_0         (0x0000u)  /* LCD_B Clock pre-scaler for blinking frequency: 0 */
#define LCDBLKPRE_1         (0x0004u)  /* LCD_B Clock pre-scaler for blinking frequency: 1 */
#define LCDBLKPRE_2         (0x0008u)  /* LCD_B Clock pre-scaler for blinking frequency: 2 */
#define LCDBLKPRE_3         (0x000Cu)  /* LCD_B Clock pre-scaler for blinking frequency: 3 */
#define LCDBLKPRE_4         (0x0010u)  /* LCD_B Clock pre-scaler for blinking frequency: 4 */
#define LCDBLKPRE_5         (0x0014u)  /* LCD_B Clock pre-scaler for blinking frequency: 5 */
#define LCDBLKPRE_6         (0x0018u)  /* LCD_B Clock pre-scaler for blinking frequency: 6 */
#define LCDBLKPRE_7         (0x001Cu)  /* LCD_B Clock pre-scaler for blinking frequency: 7 */

#define LCDBLKPRE__512      (0x0000u)  /* LCD_B Clock pre-scaler for blinking frequency: 512   */
#define LCDBLKPRE__1024     (0x0004u)  /* LCD_B Clock pre-scaler for blinking frequency: 1024  */
#define LCDBLKPRE__2048     (0x0008u)  /* LCD_B Clock pre-scaler for blinking frequency: 2048  */
#define LCDBLKPRE__4096     (0x000Cu)  /* LCD_B Clock pre-scaler for blinking frequency: 4096  */
#define LCDBLKPRE__8192     (0x0010u)  /* LCD_B Clock pre-scaler for blinking frequency: 8192  */
#define LCDBLKPRE__16384    (0x0014u)  /* LCD_B Clock pre-scaler for blinking frequency: 16384 */
#define LCDBLKPRE__32768    (0x0018u)  /* LCD_B Clock pre-scaler for blinking frequency: 32768 */
#define LCDBLKPRE__65536    (0x001Cu)  /* LCD_B Clock pre-scaler for blinking frequency: 65536 */

#define LCDBLKDIV_0         (0x0000u)  /* LCD_B Clock divider for blinking frequency: 0 */
#define LCDBLKDIV_1         (0x0020u)  /* LCD_B Clock divider for blinking frequency: 1 */
#define LCDBLKDIV_2         (0x0040u)  /* LCD_B Clock divider for blinking frequency: 2 */
#define LCDBLKDIV_3         (0x0060u)  /* LCD_B Clock divider for blinking frequency: 3 */
#define LCDBLKDIV_4         (0x0080u)  /* LCD_B Clock divider for blinking frequency: 4 */
#define LCDBLKDIV_5         (0x00A0u)  /* LCD_B Clock divider for blinking frequency: 5 */
#define LCDBLKDIV_6         (0x00C0u)  /* LCD_B Clock divider for blinking frequency: 6 */
#define LCDBLKDIV_7         (0x00E0u)  /* LCD_B Clock divider for blinking frequency: 7 */

#define LCDBLKDIV__1        (0x0000u)  /* LCD_B Clock divider for blinking frequency: /1 */
#define LCDBLKDIV__2        (0x0020u)  /* LCD_B Clock divider for blinking frequency: /2 */
#define LCDBLKDIV__3        (0x0040u)  /* LCD_B Clock divider for blinking frequency: /3 */
#define LCDBLKDIV__4        (0x0060u)  /* LCD_B Clock divider for blinking frequency: /4 */
#define LCDBLKDIV__5        (0x0080u)  /* LCD_B Clock divider for blinking frequency: /5 */
#define LCDBLKDIV__6        (0x00A0u)  /* LCD_B Clock divider for blinking frequency: /6 */
#define LCDBLKDIV__7        (0x00C0u)  /* LCD_B Clock divider for blinking frequency: /7 */
#define LCDBLKDIV__8        (0x00E0u)  /* LCD_B Clock divider for blinking frequency: /8 */
...
#define OFS_OA0CTL0           (0x0000u)  /* OA0 Control register 0 */
#define OFS_OA0CTL0_L          OFS_OA0CTL0
#define OFS_OA0CTL0_H          OFS_OA0CTL0+1
#define OFS_OA0PSW            (0x0002u)  /* OA0 Positive Input Terminal Switches */
#define OFS_OA0PSW_L           OFS_OA0PSW
#define OFS_OA0PSW_H           OFS_OA0PSW+1
#define OFS_OA0NSW            (0x0004u)  /* OA0 Negative Input Terminal Switches */
#define OFS_OA0NSW_L           OFS_OA0NSW
#define OFS_OA0NSW_H           OFS_OA0NSW+1
#define OFS_OA0GSW            (0x000Eu)  /* OA0 Ground Switches */
#define OFS_OA0GSW_L           OFS_OA0GSW
#define OFS_OA0GSW_H           OFS_OA0GSW+1

#define OAM                  (0x0001u)  /* Amplifier mode selection */
#define OARRI                (0x0020u)  /* Rail-to-rail input enable */
#define OARRIRDY             (0x0040u)  /* Rail-to-rail input ready status */

#define OAM_L               (0x0001u)  /* Amplifier mode selection */
#define OARRI_L             (0x0020u)  /* Rail-to-rail input enable */
#define OARRIRDY_L          (0x0040u)  /* Rail-to-rail input ready status */

#define PSW0                (0x0001u)  /* Positive input terminal switch 0 control */
#define PSW1                (0x0002u)  /* Positive input terminal switch 1 control */
#define PSW2                (0x0004u)  /* Positive input terminal switch 2 control */
#define PSW3                (0x0008u)  /* Positive input terminal switch 3 control */

#define PSW0_L              (0x0001u)  /* Positive input terminal switch 0 control */
#define PSW1_L              (0x0002u)  /* Positive input terminal switch 1 control */
#define PSW2_L              (0x0004u)  /* Positive input terminal switch 2 control */
#define PSW3_L              (0x0008u)  /* Positive input terminal switch 3 control */

#define NSW0                (0x0001u)  /* Negative input terminal switch 0 control */
#define NSW1                (0x0002u)  /* Negative input terminal switch 1 control */
#define NSW2                (0x0004u)  /* Negative input terminal switch 2 control */
#define NSW3                (0x0008u)  /* Negative input terminal switch 3 control */
#define NSW4                (0x0010u)  /* Negative input terminal switch 4 control */

#define NSW0_L              (0x0001u)  /* Negative input terminal switch 0 control */
#define NSW1_L              (0x0002u)  /* Negative input terminal switch 1 control */
#define NSW2_L              (0x0004u)  /* Negative input terminal switch 2 control */
#define NSW3_L              (0x0008u)  /* Negative input terminal switch 3 control */
#define NSW4_L              (0x0010u)  /* Negative input terminal switch 4 control */

#define GSW0                (0x0001u)  /* Ground switch 0 */
#define GSW1                (0x0002u)  /* Ground switch 1 */

#define GSW0_L              (0x0001u)  /* Ground switch 0 */
#define GSW1_L              (0x0002u)  /* Ground switch 1 */
...
#define OFS_OA1CTL0           (0x0000u)  /* OA1 Control register 0 */
#define OFS_OA1CTL0_L          OFS_OA1CTL0
#define OFS_OA1CTL0_H          OFS_OA1CTL0+1
#define OFS_OA1PSW            (0x0002u)  /* OA1 Positive Input Terminal Switches */
#define OFS_OA1PSW_L           OFS_OA1PSW
#define OFS_OA1PSW_H           OFS_OA1PSW+1
#define OFS_OA1NSW            (0x0004u)  /* OA1 Negative Input Terminal Switches */
#define OFS_OA1NSW_L           OFS_OA1NSW
#define OFS_OA1NSW_H           OFS_OA1NSW+1
#define OFS_OA1GSW            (0x000Eu)  /* OA1 Ground Switches */
...
#define RTCLOCK             (0x0400u)   /* RTC Real-Time clock lock */
#define RTCCALF1            (0x0200u)   /* RTC Calibration Frequency Bit 1 */
#define RTCCALF0            (0x0100u)   /* RTC Calibration Frequency Bit 0 */
...
/* RTCCTL13 Control Bits */
#define RTCLOCK_H           (0x0004u)   /* RTC Real-Time clock lock */
#define RTCCALF1_H          (0x0002u)   /* RTC Calibration Frequency Bit 1 */
#define RTCCALF0_H          (0x0001u)   /* RTC Calibration Frequency Bit 0 */
